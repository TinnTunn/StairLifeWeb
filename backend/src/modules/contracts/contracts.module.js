...
exports.ContractsModule = ContractsModule = __decorate([
    (0, common_1.Module)({
        imports: [applications_module_1.ApplicationsModule, projects_module_1.ProjectsModule],
        controllers: [contracts_controller_1.ContractsController],
        providers: [contracts_service_1.ContractsService, contracts_repository_1.ContractsRepository],
        exports: [contracts_service_1.ContractsService, contracts_repository_1.ContractsRepository],
    })
], ContractsModule);
