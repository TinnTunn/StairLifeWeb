...
let PaymentsController = class PaymentsController {
    ...
    async holdEscrow(dto, user) {
        return this.paymentsService.holdEscrow(dto, user.id);
    }
    async releaseEscrow(id, user) {
    ...
    async getByContract(contractId, user) {
...
], PaymentsController.prototype, "holdEscrow", null);
__decorate([
    (0, common_1.Patch)('escrow/:id/release'),
    (0, common_1.UseGuards)(roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)('bisnis'),
...
__decorate([
    ...
    __metadata("design:paramtypes", [String, Object]),
    __metadata("design:returntype", Promise)
], PaymentsController.prototype, "getByContract", null);
